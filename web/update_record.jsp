...
<%
    ...
    if (request.getParameter("submit") != null) {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/crud_db", "root", "Ankit");
    ...
    <body>
        <div class="container">
            ...
            <%                Connection con1;
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/crud_db", "root", "Ankit");
